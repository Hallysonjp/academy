<style>
	...
	.paypal-form, .stripe-form, .pagarme-form{
		display: none;
	}

	@media only screen and (max-width: 600px) {
	  .paypal, .stripe, .pagarme{
	    margin-left: 5px;
	    width: 70%;
	  }
	}
...
<?php
	...
	$pagarme = json_decode(get_settings('pagarme_keys'));
...
<div class="container">
	<div class="row justify-content-center mb-5">
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-12">
					<span class="payment-header-text float-left"><b>Finalizar pedido</b></span>
	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-3">
					<p class="pb-2 payment-header">Método de pagamento</p>
<!---->
...
<!--						</div>-->
<!--					--><?php //endif; ?>
					<?php if ($pagarme[0]->active != 0): ?>
                        <div class="row payment-gateway pagarme" onclick="selectedPaymentGateway('pagarme')">
                            <div class="col-12">
                                <img class="tick-icon pagarme-icon" src="<?php echo base_url('assets/payment/tick.png'); ?>">
                                <img class="payment-gateway-icon" src="<?php echo base_url('assets/payment/pagarme.svg'); ?>">
                            </div>
                        </div>
                    <?php endif; ?>
				...
				<div class="col-md-8">
					<div class="w-100">
						<p class="pb-2 payment-header">Detalhes da compra</p>
						<?php $counter = 0 ?>
...
<!--			            </form>-->
                        <form action="<?php echo site_url('home/pagarme_checkout'); ?>" method="post" class="pagarme-form form">
                            <hr class="border mb-4">
                            <input type="hidden" name="total_price_of_checking_out" value="<?php echo $total_price_of_checking_out; ?>">
                            <button type="submit" class="payment-button float-right">Realizar Pagamento</button>
                        </form>
...
<script type="text/javascript">
	function selectedPaymentGateway(gateway){
		if(gateway == 'paypal'){
            ...
            $(".pagarme").css("border","2px solid #00D04F");
            $('.pagarme-icon').show();
            $('.pagarme-form').show();
        }
	}
