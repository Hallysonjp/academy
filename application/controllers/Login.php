...
class Login extends CI_Controller {
    ...
    public function register() {
        ...
        $pagarme_info = [];
        $pagarme_keys = [
            'api_key'     => 'ak_test_CnbrsEGr30lk4t8lmFwrMHrw5NL4uz',
            'encrypt_key' => 'ek_test_GGcqjfdHrNxUm25O3EM315hJOT3CDD'
        ];

        array_push($pagarme_info, $pagarme_keys);
        $data['pagarme_keys'] = json_encode($pagarme_info);
